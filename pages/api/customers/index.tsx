...
export const getCustomers = async() : Promise<Customer[]> => {
    ...
    const data = await mongoClient.db().collection('customers').find().toArray() as Customer[];
...
export const addCustomer = async(customer : Customer): Promise<ObjectId> => {
    ...
    const response = await mongoClient.db().collection('customers').insertOne(customer)
